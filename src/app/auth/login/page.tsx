        ...
        <div className="relative z-10 space-y-8">
          <div className="space-y-4">
            <div className="inline-flex items-center gap-2 bg-primary/5 border border-primary/10 rounded-full px-4 py-1.5">
              ...
              <span className="text-muted-foreground text-xs font-medium">Platform Aktif & Aman</span>
            </div>
            <h1 className="text-5xl xl:text-6xl font-bold text-foreground leading-tight tracking-tight">
              Kelola Kantor<br />
          ...
          <div className="flex flex-wrap gap-3">
            {["Manajemen Akta Digital", "Klien Terintegrasi", "Laporan Otomatis", "Keamanan Berlapis"].map((f) => (
              <div
                key={f}
                className="flex items-center gap-2 bg-primary/5 border border-primary/10 rounded-full px-3 py-1.5"
              >
                <ShieldCheck className="h-3 w-3 text-primary" />
                <span className="text-muted-foreground text-xs font-medium">{f}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="relative z-10 grid grid-cols-3 gap-6">
          {[
            ...
            <div key={s.label} className="space-y-1">
              <p className="text-foreground font-bold text-2xl">{s.value}</p>
      ...
      <div className="w-full lg:w-1/2 xl:w-2/5 flex items-center justify-center p-6 sm:p-12 bg-card relative">
        ...
        <div className="w-full max-w-sm relative z-10">
          ...
          <div className="space-y-2 mb-10">
            <h2 className="text-3xl font-bold text-foreground tracking-tight">Selamat Datang</h2>
            <p className="text-muted-foreground text-sm">Masuk untuk mengakses dasbor Anda</p>
          </div>
